    ...
    <div className="w-full mb-4 mt-8">
            ...
            >
              ...
              <div className="h-48 overflow-hidden flex justify-center">
                <img
                  ...
                  className="w-fit h-full hover:scale-105 transition-transform duration-500"
                />
              </div>
              {/* Content */}
              <div className="p-6">
                ...
                <button
                  ...
                  className="text-gray-800 cursor-pointer poppins-semi text-sm md:text-base hover:text-[#C49A6C] transition-colors duration-300 border-b border-gray-800 hover:border-[#C49A6C] pb-1"
                >
                  Discover
                </button>
              </div>
      ...
      <div className="hidden md:grid grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        {collections.map((collection) => (
          ...
          >
            {/* Image Container */}
            <div className="h-48 md:h-48 overflow-hidden flex justify-center">
              <img
                src={collection.image}
                alt={collection.title}
                className="w-fit h-full hover:scale-105 transition-transform duration-500"
