...
const testimonials = [
  {
    ...
    content:
      "Our restaurant staff find the seating very comfortable and the reservation system is easy to use.",
  ...
  },
  {
    ...
    content:
      "The quality is outstanding, and their team was a dream to work with. Our guests always compliment the stylish, comfortable vibe!",
    source: "Facebook",
  ...
  },
  {
    ...
    content:
      "Loved the booth seating options. It elevated our cafe look and feel, and customers are loving the comfort.",
    source: "Instagram",
    author: "Ella Martin",
...
const Testimonials = () => {
  ...
  const getMaxIndex = () => {
    ...
    if (width >= 768 && width < 1024) return testimonials.length - 1; // tablet
    return testimonials.length - 2; // desktop
  };

  const [maxIndex, setMaxIndex] = useState(testimonials.length - 1); // Safe default for SSR
            ...
            {testimonials.map((t, idx) => (
              <div
                ...
                className={classNames(
                  ...
                  {
                    "opacity-40 md:scale-[0.95]":
                      !isMobile && idx !== current && idx !== current + 1,
              ...
              >
                ...
                <p className="text-sm  text-[#C49A6C] helvetica-bold mb-1">
                  Source - {t.source}
                </p>
                <p className="poppins-semi text-sm">{t.author}</p>
                <p className="italic poppins-light text-xs text-gray-500">
                  {t.position}
                </p>
              </div>
            ))}
        ...
        <div className="flex flex-col justify-between w-full md:w-1/2">
          <div className="mb-6">
            <h2 className="text-xl md:text-3xl w-full  md:w-[90%] lg:w-[70%] helvetica-bold mb-3">
              Trusted by <span className="text-[#C49A6C]">Australia’s</span>{" "}
              Finest Venues
            </h2>
            <p className="text-gray-700 text-sm md:text-xl poppins-light w-full md:w-[90%]">
              Barbin Furniture transformed our dining space with their Rochester
              chairs and custom booth seating. The quality is outstanding, and
              their team was a dream to work with. Our guests always compliment
              the stylish, comfortable vibe!
            </p>
          </div>
          <div className="flex gap-3">
            ...
            <button
              onClick={nextSlide}
              className="w-10 h-10 rounded-full bg-[#3A240F] text-white flex items-center justify-center"
            >
