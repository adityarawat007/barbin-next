...
const slides = [
  {
    ...
    description: "Over 30 years of trusted service to the Australian hospitality industry.",
    image: "/man3.png",
  },
  {
    title: "The Barbin Way",
    subtitle: "Trusted & Professional.",
    description: "Delivering excellence in every project with industry-leading standards.",
    image: "/man3.png",
  },
  {
    title: "The Barbin Promise",
    subtitle: "Quality & Commitment.",
    description: "We're committed to providing high-quality service you can rely on.",
    image: "/man3.png",
  },
];
      ...
      <div className=" w-full lg:max-w-7xl mt-20  mx-auto flex flex-col lg:flex-row items-start lg:items-center gap-8">
        ...
        <div className="hidden md:block -mt-[15%] w-xs text-center md:text-left">
            ...
            {slides.map((_, index) => (
              <div
                ...
                className={`w-2 h-2 rounded-full transition-colors duration-300 ${
                  index === currentIndex ? 'bg-[#3C2415]' : 'border border-[#3C2415] rounded-full'
                }`}
              />
            ))}
          </div>
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl helvetica-bold mb-8 leading-tight">
            {slide.title.split(" ").map((word, i) =>
              word === "Barbin" ? (
                <span key={i} className="text-[#C49A6C]">{word} </span>
              ) : (
                word + " "
              )
            )}
        ...
        <div className="hidden  md:flex flex-row justify-start lg:justify-center items-end gap-5">
            ...
            <h2 className="text-4xl lg:text-5xl helvetica-bold mb-4 leading-tight text-[#563827]">
              {slide.subtitle.split(" & ").map((text, i) => (
                <React.Fragment key={i}>
                  ...
                  {i === 0 && slide.subtitle.includes(" & ") && <span className="text-black"> & </span>}
                </React.Fragment>
              ))}
            </h2>
          ...
          <div className="w-[80%] lg:w-md flex items-center relative justify-between lg:justify-start gap-4">
            <div className="bg-[#563827] w-[275px] lg:w-[360px] h-[280px] p-4 rounded-xl">
              <img
                src={slide.image}
                alt="Professional worker"
                loading='lazy'
                className="rounded-xl h-[435px] md:w-[90%] md:h-[420px] lg:h-[500px]  lg:w-full  -top-[50%] lg:-top-[78.5%]  absolute  md:-left-[12%] lg:-left-[14%]"
              />
            </div>
        ...
        <div className="md:hidden flex flex-col -mt-20  px-2 items-start w-full space-y-6">
          ...
          <div className="flex flex-row  w-full gap-4 justify-between items-end">
            ...
            <div className="bg-[#563827] w-[100%] h-[140px] relative rounded-xl ">
              <img
                ...
                loading='lazy'
                alt="Professional worker"
                className="rounded-md w-[100%] object-cover   h-[150%]  absolute right-1 bottom-0  z-50"
              />
          ...
          {/* <img
                src='/man3.png'
                alt="Professional worker"
                className=" w-[60%]  h-[230px]  absolute rounded-xl right-0 z-50"
              /> */}
            </div>
